...
<!--        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <select class="val" name="select_firsttworow" id="" title="2500">
        ...
        <tr>
            ...
            <td>
                ...
                <select class="val" name="select_premierseatingdinner" id="" title="1000">
        ...
        <tr>
            ...
            <td>
                ...
                <select class="val" name="select_preferredseatingdinner" id="" title="600">
        ...
        <tr>
            ...
            <td>
                ...
                <select class="val" name="select_standardseatingdinner" id="" title="400">
