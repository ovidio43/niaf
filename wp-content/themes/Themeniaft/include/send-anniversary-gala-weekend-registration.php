...
$member = Array(
    'select_firsttworow' => 'Number of Member First Two Rows Dinner Ticket(s) @ $2,000 (Quote)',
//    'firsttworow' => 'First Two Rows Dinner Ticket(s) @ $2,000 (total)',
    'select_premierseatingdinner' => 'Number of Member Premier Seating Dinner Ticket(s) @ $850 (Quote)',
//    'premierseatingdinner' => 'Premier Seating Dinner Ticket(s) @ $850 (total) ',
    'select_preferredseatingdinner' => 'Number of Member Preferred Seating Dinner Ticket(s) @ $500 (Quote)',
//    'preferredseatingdinner' => 'Preferred Seating Dinner Ticket(s) @ $500 (total) ',
    'select_standardseatingdinner' => 'Number of Member Standard Seating Dinner Ticket(s) @ $350 (Quote)',
//    'standardseatingdinner' => 'Standard Seating Dinner Ticket(s) @ $350 (total)',
    'select_young_professional2' => 'Number of Member Young Professional (under 30) @ $250 (Quote)',
//    'young_professional2' => 'Young Professional (under 30) @ $250 (total)',
);
$nonMember = Array(
    'select_firsttworow' => 'Number of Non-Member First Two Rows Dinner Ticket(s) @ $2,500 (Quote)',
//    'firsttworow' => 'First Two Rows Dinner Ticket(s) @ $2,500 (total)',
    'select_premierseatingdinner' => 'Number of Non-Member Premier Seating Dinner Ticket(s) @ $1,000 (Quote)',
//    'premierseatingdinner' => 'Premier Seating Dinner Ticket(s) @ $1,000 (total)',
    'select_preferredseatingdinner' => 'Number of Non-Member Preferred Seating Dinner Ticket(s) @ $600 (Quote)',
//    'preferredseatingdinner' => 'Preferred Seating Dinner Ticket(s) @ $600 (total)',
    'select_standardseatingdinner' => 'Number of Non-Member Standard Seating Dinner Ticket(s) @ $400 (Quote)',
//    'standardseatingdinner' => 'Standard Seating Dinner Ticket(s) @ $400 (total)',
    'select_young_professional2' => 'Number of Non-Member Young Professional (under 30) @ $300 (Quote)',
...
echo formating_body($_POST);

function formating_body($data) {
